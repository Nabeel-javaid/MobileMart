                    ...
                    <div className="p-6">
                        ...
                        <div className="grid grid-cols-4 gap-2">
                            {productImages.map((img, index) => (
                                <motion.button
                                    key={index}
                                    className={`aspect-square rounded-md overflow-hidden border-2 ${index === activeImage ? 'border-primary' : 'border-transparent'
                                        }`}
                        ...
                        <div className="flex-1">
                            ...
                            <div className="mb-6">
                                <div className="flex items-baseline">
                                    ...
                                    {discount && (
                                        <span className="ml-2">
                                            <Badge variant="success" className="text-sm px-2 py-0.5">Save {discount}%</Badge>
                                        </span>
                                    )}
                                </div>
                                            ...
                                            <div className="flex">
                                                {[1, 2, 3, 4, 5].map((star) => {
                                                    ...
                                                    return (
                                                        <Star
                                                            key={star}
                                                            className={`h-3 w-3 ${star <= rating ? 'text-yellow-400 fill-yellow-400' : 'text-slate-300'
                                                                }`}
                                                        />
                                                    );
                                                })}
